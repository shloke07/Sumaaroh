...
const CardScreen = () => {
  ...
  return (
    <>
      ...
      >
          <div className="logo-container py-4 text-center mb-4 cursor-pointer"
                  style={{
                    backgroundImage: `url(${backgroundImage})`,
                    backgroundSize: "cover",
                    backgroundPosition: "center",
        ...
        <div className="card-screen-container flex flex-col lg:flex-row bg-gradient-to-r from-white to-[#FDFDF1] h-screen w-screen"
                style={{
                  backgroundImage: `url(${backgroundImage})`,
                  backgroundSize: "cover",
                  backgroundPosition: "center",
        ...
        >
          {/* Left Section */}
          <div className="flex justify-center items-center w-lg lg:w-1/2 p-4">
            <img
              src={image}
              alt="Event Planning"
              className="w-full max-w-lg lg:max-w-lg"
            />
          </div>
